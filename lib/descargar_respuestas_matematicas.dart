...
class DescargarRespuestasMatematicas extends StatefulWidget {
  final String profesor;
  final int trimestre;

  const DescargarRespuestasMatematicas({Key? key, required this.profesor, required this.trimestre}) : super(key: key);

  @override
  _DescargarRespuestasMatematicasState createState() => _DescargarRespuestasMatematicasState();
}

class _DescargarRespuestasMatematicasState extends State<DescargarRespuestasMatematicas> {
